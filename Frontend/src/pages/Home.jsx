            ...
            <li key={i} className="flex items-center gap-3 text-sm group/item">
              ...
              <span
                className={`font-semibold ${
                  darkMode ? "text-gray-300 group-hover/item:text-white" : "text-slate-700 group-hover/item:text-slate-900"
                }`}
              >
                {point}
              </span>
                  ...
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                      <div className="relative w-64 h-64 lg:w-80 lg:h-80">
                        ...
                        {/* Static Rings */}
                        <div className="absolute inset-0 rounded-full border-2 border-blue-300/50 dark:border-blue-500/30" />
                        <div className="absolute inset-4 rounded-full border-2 border-purple-300/50 dark:border-purple-500/30" />
                        <div className="absolute inset-8 rounded-full border-2 border-pink-300/50 dark:border-pink-500/30" />
                        ...
                        {[
                          ...
                          >
                            <div
                              className={`p-3 rounded-full bg-white dark:bg-gray-800 shadow-xl ${
                                darkMode ? "shadow-blue-900/20" : "shadow-blue-200"
                              }`}
                            >
                              {item.icon}
                            </div>
                        ...
                        {/* Central Pulsating Core - Static */}
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                          <div
                            className={`w-24 h-24 lg:w-28 lg:h-28 rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center shadow-2xl ${
                              darkMode ? "shadow-purple-900/50" : "shadow-purple-400/50"
                            }`}
                          >
